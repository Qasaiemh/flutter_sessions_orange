...
import 'package:test1/animated_onbboarding/screens/mainscreen.dart';
import 'package:test1/animated_onbboarding/screens/onboard/welcome_page.dart';
...
class _OnboardState extends State<Onboard> with SingleTickerProviderStateMixin {
  List<OnboardPageItem> onboardPageItems = [
    OnboardPageItem(
      lottieAsset: 'assets/animations/animation_2.json',
      text: 'See friends stories and events going on around you', animationDuration: const Duration(milliseconds: 1100),
    ),
    OnboardPageItem(
